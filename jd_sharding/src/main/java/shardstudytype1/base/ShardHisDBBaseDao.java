...
import com.jd.treasure.dao.shard.utils.SqlSessionFactoryContextHolder;
...
@Repository("shardHisDBBaseDao")
public class ShardHisDBBaseDao implements GenericBaseDAO{
     ...
     * Logger
     */
    private static final Logger log = LoggerFactory.getLogger(ShardHisDBBaseDao.class);
    ...
    private void routerMasterSqlSessionFactoryContextHolder(Object bindParams){
        // 要注意是基础库主库还是各分库主库
        SqlSessionFactoryContextHolder.setContextType("sqlSessionFactoryMaster_99");
    }


    private void routerSlaveSqlSessionFactoryContextHolder(Object bindParams){
        SqlSessionFactoryContextHolder.setContextType("treasureSlaveDataSource_99");
    }
